				...
				<div class="col-md-7">
					<div class="card">
						<div class="card-body">
							...
							<form action="<?= base_url('admin/dataParent/tambahDataAksi') ?>" method="POST">

								<div class="form-group">
									<label>Nama Parent</label>
									<input type="text" name="nama_parents" class="form-control">
								...
								<div class="form-group">
									...
									<input type="text" name="email_parents" class="form-control">
